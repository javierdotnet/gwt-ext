...
<!--          <li>
            <xsl:element name="a">
              ...
              <xsl:variable name="href">
                ./com.gwtext.doc.DeveloperGuide.html
              </xsl:variable>
          ...
          <li>
            <xsl:element name="a">
              <xsl:if
                test="not(contains(id, 'com.gwtext.doc.')) and (contains(id, 'com.google.gwt.') or contains(id, 'java.') or id = 'gwt' or id = 'jre')">
                <xsl:attribute name="class">
                  <xsl:text>selected</xsl:text>
                </xsl:attribute>
              </xsl:if>
              <xsl:variable name="href">./gwtext.html</xsl:variable>
              <xsl:attribute name="href">
                <xsl:value-of select="normalize-space($href)" />
              </xsl:attribute>
