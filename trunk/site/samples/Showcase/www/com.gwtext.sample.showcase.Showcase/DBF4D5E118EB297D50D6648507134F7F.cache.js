...
function FG(b){uG();var a,c,d,e;e=rK(b);d=lf('[Lcom.gwtext.client.data.Record;',[466],[30],[e.a],null);for(a=0;a<e.a;a++){c=e[a];d[a]=qF(new kF(),c);}return d;}
...
function qab(e){var a,b,c,d,f;c=d2(new F1());o2(c,false);l2(c,30);q2(c,false);h2(c,false);f=d2(new F1());o2(f,true);l2(f,300);n2(f,175);m2(f,400);q2(f,true);k2(f,true);g2(f,true);j2(f,false);h2(f,false);b=d2(new F1());o2(b,true);l2(b,202);n2(b,175);m2(b,400);q2(b,true);k2(b,true);g2(b,true);h2(b,false);d=d2(new F1());o2(d,true);l2(d,100);n2(d,100);m2(d,200);q2(d,true);k2(d,true);g2(d,true);j2(d,true);h2(d,false);a=d2(new F1());q2(a,false);h2(a,true);p2(a,'top');return x0(new v0(),'100%','100%',c,null,f,null,a);}
...
function vab(b,a){pab();var c;c=sf(DE(b),28);return c===null||DE(c)===null?a:vab(c,A6(c)+'>'+a);}
...
function p_(h,b){var a,c,d,e,f,g;g=vab(h,A6(h));if(kPb(this.a.b,g)){d=sf(lPb(this.a.b,g),48);f=E0(this.b,(e2(),r2));z2(f,true);e=lab(d);for(c=0;c<e.a;c++){a=e[c];y0(this.b,a);}B2(f,0);}}
function m_(){}
...
function iab(){var a,b,c,d;d=q1(new e1(),yB(),'View');t1(d,this.dc());c=this.Fb();if(c!==null){a=this.xb();if(a!==null){this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[464],[15],[3],null);this.h[2]=mab(this,'Data',a);}else{this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[464],[15],[2],null);}b=mab(this,'Source',c);this.h[0]=d;this.h[1]=b;}else{this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[464],[15],[1],null);this.h[0]=d;}}
function fab(){}
...
function eyb(){var a,b,c,d,e,f;c=AD(new zD(),'data/plants.xml','GET');d=pH(new iH(),'plant',mF(new lF(),mf('[Lcom.gwtext.client.data.FieldDef;',460,27,[dH(new cH(),'common'),dH(new cH(),'botanical'),dH(new cH(),'light'),vD(new uD(),'price'),oD(new mD(),'availDate','availability','m/d/Y'),fD(new eD(),'indoor')])));e=rG(new kG(),c,d);a=bY(new DX(),mf('[Lcom.gwtext.client.widgets.grid.ColumnConfig;',468,32,[axb(new uwb(),this),ixb(new gxb(),this),mxb(new kxb(),this),xxb(new vxb(),this),Fxb(new Dxb(),this)]));gY(a,true);b=oY(new kY(),'grid-example2','600px','300px',e,a);xZ(b,new ywb());e0(b);CG(e,Dwb(new Bwb(),this));f=kab(this);vu(f,Dq(new cp(),'<h1>Editor Grid Example<\/h1>'));vu(f,Dq(new cp(),'<p>This example shows how to create a grid with inline editing. Try double clicking on the table cells.<\/p>'));vu(f,b);yu(f,(gr(),hr));return f;}
function twb(){}
...
function Cwb(a){{oG(a,mf('[Lcom.gwtext.client.core.UrlParam;',467,31,[EC(new CC(),'rnd',dOb(aOb(new FNb()))+'')]));}}
...
function uyb(a){{oG(a,mf('[Lcom.gwtext.client.core.UrlParam;',467,31,[DC(new CC(),'start',0),DC(new CC(),'limit',25)]));}}
