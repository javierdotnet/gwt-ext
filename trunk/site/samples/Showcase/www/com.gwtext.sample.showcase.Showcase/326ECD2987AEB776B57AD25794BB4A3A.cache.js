...
function xG(b){mG();var a,c,d,e;e=jK(b);d=lf('[Lcom.gwtext.client.data.Record;',[467],[30],[e.a],null);for(a=0;a<e.a;a++){c=e[a];d[a]=iF(new cF(),c);}return d;}
...
function iab(e){var a,b,c,d,f;c=B1(new x1());g2(c,false);d2(c,30);i2(c,false);F1(c,false);f=B1(new x1());g2(f,true);d2(f,300);f2(f,175);e2(f,400);i2(f,true);c2(f,true);E1(f,true);b2(f,false);F1(f,false);b=B1(new x1());g2(b,true);d2(b,202);f2(b,175);e2(b,400);i2(b,true);c2(b,true);E1(b,true);F1(b,false);d=B1(new x1());g2(d,true);d2(d,100);f2(d,100);e2(d,200);i2(d,true);c2(d,true);E1(d,true);b2(d,true);F1(d,false);a=B1(new x1());i2(a,false);F1(a,true);h2(a,'top');return p0(new n0(),'100%','100%',c,null,f,null,a);}
...
function nab(b,a){hab();var c;c=sf(vE(b),28);return c===null||vE(c)===null?a:nab(c,s6(c)+'>'+a);}
...
function h_(h,b){var a,c,d,e,f,g;g=nab(h,s6(h));if(cPb(this.a.b,g)){d=sf(dPb(this.a.b,g),48);f=w0(this.b,(C1(),j2));r2(f,true);e=dab(d);for(c=0;c<e.a;c++){a=e[c];q0(this.b,a);}t2(f,0);}}
function e_(){}
...
function aab(){var a,b,c,d;d=i1(new C0(),qB(),'View');l1(d,this.cc());c=this.Eb();if(c!==null){a=this.wb();if(a!==null){this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[465],[15],[3],null);this.h[2]=eab(this,'Data',a);}else{this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[465],[15],[2],null);}b=eab(this,'Source',c);this.h[0]=d;this.h[1]=b;}else{this.h=lf('[Lcom.gwtext.client.widgets.layout.ContentPanel;',[465],[15],[1],null);this.h[0]=d;}}
function D_(){}
...
function Cxb(){var a,b,c,d,e,f;c=sD(new rD(),'data/plants.xml','GET');d=hH(new aH(),'plant',eF(new dF(),mf('[Lcom.gwtext.client.data.FieldDef;',461,27,[BG(new AG(),'common'),BG(new AG(),'botanical'),BG(new AG(),'light'),nD(new mD(),'price'),gD(new eD(),'availDate','availability','m/d/Y'),DC(new CC(),'indoor')])));e=jG(new cG(),c,d);a=zX(new vX(),mf('[Lcom.gwtext.client.widgets.grid.ColumnConfig;',469,32,[ywb(new mwb(),this),axb(new Ewb(),this),exb(new cxb(),this),pxb(new nxb(),this),xxb(new vxb(),this)]));EX(a,true);b=gY(new cY(),'grid-example2','600px','300px',e,a);pZ(b,new qwb());CZ(b);uG(e,vwb(new twb(),this));f=cab(this);ju(f,rq(new wo(),'<h1>Editor Grid Example<\/h1>'));ju(f,rq(new wo(),'<p>This example shows how to create a grid with inline editing. Try double clicking on the table cells.<\/p>'));ju(f,b);mu(f,(Aq(),Bq));return f;}
function lwb(){}
...
function uwb(a){{gG(a,mf('[Lcom.gwtext.client.core.UrlParam;',468,31,[wC(new uC(),'rnd',BNb(yNb(new xNb()))+'')]));}}
...
function myb(a){{gG(a,mf('[Lcom.gwtext.client.core.UrlParam;',468,31,[vC(new uC(),'start',0),vC(new uC(),'limit',25)]));}}
