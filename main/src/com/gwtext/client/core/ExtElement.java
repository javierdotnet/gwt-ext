...
public class ExtElement extends BaseElement {
     ...
     * @see #endMeasure()
     */
    public native void beginMeasure() /*-{
        var elem = this.@com.gwtext.client.core.JsObject::jsObj;
        elem.beginMeasure();
    }-*/;
   ...
   /**
     ...
     */
    public native int[] getAlignToXY(Element element, AnchorPosition elementAnchor, AnchorPosition targetAnchor) /*-{
        var elem = this.@com.gwtext.client.core.JsObject::jsObj;
     ...
     * @return an array containing the element's x and y coordinates
     */
    public native int[] getAlignToXY(Element element, AnchorPosition elementAnchor, AnchorPosition targetAnchor, int[] offesets) /*-{
        var elem = this.@com.gwtext.client.core.JsObject::jsObj;
        var position1JS = elementAnchor.@com.gwtext.client.core.AnchorPosition::getPosition()();
        var position2JS = targetAnchor.@com.gwtext.client.core.AnchorPosition::getPosition()();
        var positionJS = position1JS = '-' + position2JS;
     ...
     *  Gets the x,y coordinates specified by the anchor position on the element.
     *
     * @param anchor the specified anchor position (defaults to {@link AnchorPosition#CENTER}).
     ...
     * @return an array containing the element's x and y coordinates
     */
    public native int[] getAnchorXY(AnchorPosition anchor, boolean local, int width, int height) /*-{
        var elem = this.@com.gwtext.client.core.JsObject::jsObj;
     ...
     * @return the mask element
     */
    public native ExtElement mask(String msg) /*-{
