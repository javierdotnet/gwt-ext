    ...
    private static void load(XMLTreeLoaderConfig config, TreeNode currentNode, NodeList chidren) {
                       for (int i = 0; i < chidren.getLength(); i++) {
                           ...
                           if (name.equals(folderTag)) {
                               ...
                               final String checked = evaluateNodeValue(child, config.getFolderCheckedMapping());
                               ...
                               if(checked != null) {
                                   if(checked.equalsIgnoreCase("true") || checked.equals("1")) {
                                       nodeConfig.setChecked(true);
                                   } else {
                                       nodeConfig.setChecked(false);
                                   }
                               }
                               ...
                               final String checked = evaluateNodeValue(child, config.getLeafCheckedMapping());
